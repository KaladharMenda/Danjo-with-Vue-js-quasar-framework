...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'addunitmarks', component: () => genericImport('addunitmarks') },
      { path: 'viewunitmarks', component: () => genericImport('viewunitmarks') },
      { path: 'addsmmarks', component: () => genericImport('addsmmarks') },
      { path: 'viewsmmarks', component: () => genericImport('viewsmmarks') },
      { path: 'addpmmarks', component: () => genericImport('addpmmarks') },
      { path: 'viewpmmarks', component: () => genericImport('viewpmmarks') },
      { path: 'detainedlist', component: () => genericImport('detainedlist') },
      { path: 'condonationlist', component: () => genericImport('condonationlist') },
